...
// Datos de ejemplo (no comentar esta sección)
const items = [
...
// Acceder por índice y luego por propiedad con punto
...
// filter retorna array con elementos que cumplen la condición
...
// Al retornar un objeto literal, envolver en paréntesis: item => ({ ...item, ... })
...
// Encadenar operaciones: filtrar → ordenar → transformar
// IMPORTANTE: usar [...items].sort() para no mutar el array original
