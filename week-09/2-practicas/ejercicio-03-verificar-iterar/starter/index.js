...
// Object.hasOwn(obj, key) verifica si el objeto tiene esa propiedad propia
// Forma moderna de ES2022 — reemplaza a obj.hasOwnProperty()
...
// const existing = fieldNames.filter((field) =>
...
// El operador 'in' incluye propiedades heredadas (como 'toString', 'valueOf')
// Object.hasOwn() solo verifica propiedades propias del objeto
...
// for...in recorre todas las claves enumerables del objeto
// Se usa hasOwn para filtrar y quedarse solo con las propiedades propias
...
// Verificar propiedades opcionales antes de usarlas evita errores
