...
// Índice del primer nombre largo (> 6 letras)
// const longNameIndex = names.findIndex((name) => name.length > 6);
// console.log("Índice nombre largo:", longNameIndex);      // 1 — "Beatriz"
...
// Uso práctico: actualizar un elemento
